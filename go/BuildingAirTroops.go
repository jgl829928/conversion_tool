...
type BuildingAirTroopsRow struct {
...
type BuildingAirTroopsTable struct {
	rows []BuildingAirTroopsRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingAirTroops = BuildingAirTroopsTable{}
)

func (this *BuildingAirTroopsTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingAirTroopsTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAirTroopsTable) Row(i int) (row BuildingAirTroopsRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAirTroopsTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingAirTroopsRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAirTroopsTable) RowType() BuildingAirTroopsRow {
    return BuildingAirTroopsRow{}
}

func (this *BuildingAirTroopsTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingAirTroopsTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAirTroopsTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingAirTroopsTable) createRow(records [][]string) (rows []BuildingAirTroopsRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingAirTroopsRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingAirTroopsRow))
	}

    log.Trace("load table BuildingAirTroops len(%v)",len(rows))
	return
}

func (this *BuildingAirTroopsTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAirTroopsTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingAirTroopsTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingAirTroopsTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingAirTroopsTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingAirTroopsTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingAirTroopsTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingAirTroopsTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingAirTroopsTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
