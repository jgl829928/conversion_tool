...
type BuildingAmmoPlantRow struct {
...
type BuildingAmmoPlantTable struct {
	rows []BuildingAmmoPlantRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingAmmoPlant = BuildingAmmoPlantTable{}
)

func (this *BuildingAmmoPlantTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingAmmoPlantTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAmmoPlantTable) Row(i int) (row BuildingAmmoPlantRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAmmoPlantTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingAmmoPlantRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAmmoPlantTable) RowType() BuildingAmmoPlantRow {
    return BuildingAmmoPlantRow{}
}

func (this *BuildingAmmoPlantTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingAmmoPlantTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAmmoPlantTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingAmmoPlantTable) createRow(records [][]string) (rows []BuildingAmmoPlantRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingAmmoPlantRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingAmmoPlantRow))
	}

    log.Trace("load table BuildingAmmoPlant len(%v)",len(rows))
	return
}

func (this *BuildingAmmoPlantTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingAmmoPlantTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingAmmoPlantTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingAmmoPlantTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingAmmoPlantTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingAmmoPlantTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingAmmoPlantTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingAmmoPlantTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingAmmoPlantTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
