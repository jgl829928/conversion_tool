...
type BuildingArtilleryTroopsRow struct {
...
type BuildingArtilleryTroopsTable struct {
	rows []BuildingArtilleryTroopsRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingArtilleryTroops = BuildingArtilleryTroopsTable{}
)

func (this *BuildingArtilleryTroopsTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingArtilleryTroopsTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingArtilleryTroopsTable) Row(i int) (row BuildingArtilleryTroopsRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingArtilleryTroopsTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingArtilleryTroopsRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingArtilleryTroopsTable) RowType() BuildingArtilleryTroopsRow {
    return BuildingArtilleryTroopsRow{}
}

func (this *BuildingArtilleryTroopsTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingArtilleryTroopsTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingArtilleryTroopsTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingArtilleryTroopsTable) createRow(records [][]string) (rows []BuildingArtilleryTroopsRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingArtilleryTroopsRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingArtilleryTroopsRow))
	}

    log.Trace("load table BuildingArtilleryTroops len(%v)",len(rows))
	return
}

func (this *BuildingArtilleryTroopsTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingArtilleryTroopsTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingArtilleryTroopsTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingArtilleryTroopsTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingArtilleryTroopsTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingArtilleryTroopsTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingArtilleryTroopsTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingArtilleryTroopsTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingArtilleryTroopsTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
