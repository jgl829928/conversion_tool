...
type BuildingBunkerRow struct {
 ...
 INT_UNIT_ATK   int32   `colname:"INT_UNIT_ATK"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingBunkerTable struct {
	rows []BuildingBunkerRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingBunker = BuildingBunkerTable{}
)

func (this *BuildingBunkerTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingBunkerTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingBunkerTable) Row(i int) (row BuildingBunkerRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingBunkerTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingBunkerRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingBunkerTable) RowType() BuildingBunkerRow {
    return BuildingBunkerRow{}
}

func (this *BuildingBunkerTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingBunkerTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingBunkerTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingBunkerTable) createRow(records [][]string) (rows []BuildingBunkerRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingBunkerRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingBunkerRow))
	}

    log.Trace("load table BuildingBunker len(%v)",len(rows))
	return
}

func (this *BuildingBunkerTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingBunkerTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingBunkerTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingBunkerTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_UNIT_ATK,true
 case 16 :
...
func (this *BuildingBunkerTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingBunkerTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingBunkerTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingBunkerTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingBunkerTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
