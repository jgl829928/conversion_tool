...
type BuildingCollegeRow struct {
 ...
 INT_RESEARCH_SPEED_UP   int32   `colname:"INT_RESEARCH_SPEED_UP"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingCollegeTable struct {
	rows []BuildingCollegeRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingCollege = BuildingCollegeTable{}
)

func (this *BuildingCollegeTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingCollegeTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCollegeTable) Row(i int) (row BuildingCollegeRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCollegeTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingCollegeRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCollegeTable) RowType() BuildingCollegeRow {
    return BuildingCollegeRow{}
}

func (this *BuildingCollegeTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingCollegeTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCollegeTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingCollegeTable) createRow(records [][]string) (rows []BuildingCollegeRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingCollegeRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingCollegeRow))
	}

    log.Trace("load table BuildingCollege len(%v)",len(rows))
	return
}

func (this *BuildingCollegeTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCollegeTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingCollegeTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingCollegeTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_RESEARCH_SPEED_UP,true
 case 16 :
...
func (this *BuildingCollegeTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingCollegeTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingCollegeTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingCollegeTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingCollegeTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
