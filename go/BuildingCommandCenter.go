...
type BuildingCommandCenterRow struct {
 ...
 INT_MARCH_COUNT   int32   `colname:"INT_MARCH_COUNT"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingCommandCenterTable struct {
	rows []BuildingCommandCenterRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingCommandCenter = BuildingCommandCenterTable{}
)

func (this *BuildingCommandCenterTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingCommandCenterTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCommandCenterTable) Row(i int) (row BuildingCommandCenterRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCommandCenterTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingCommandCenterRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCommandCenterTable) RowType() BuildingCommandCenterRow {
    return BuildingCommandCenterRow{}
}

func (this *BuildingCommandCenterTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingCommandCenterTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCommandCenterTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingCommandCenterTable) createRow(records [][]string) (rows []BuildingCommandCenterRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingCommandCenterRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingCommandCenterRow))
	}

    log.Trace("load table BuildingCommandCenter len(%v)",len(rows))
	return
}

func (this *BuildingCommandCenterTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingCommandCenterTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingCommandCenterTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingCommandCenterTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_MARCH_COUNT,true
 case 16 :
...
func (this *BuildingCommandCenterTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingCommandCenterTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingCommandCenterTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingCommandCenterTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingCommandCenterTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
