...
type BuildingDefenseCenterRow struct {
 ...
 INT_RECRUIT_SPEEDUP   int32   `colname:"INT_RECRUIT_SPEEDUP"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`
 INT_TRAIN_COUNT   int32   `colname:"INT_TRAIN_COUNT"`

}

type BuildingDefenseCenterTable struct {
	rows []BuildingDefenseCenterRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingDefenseCenter = BuildingDefenseCenterTable{}
)

func (this *BuildingDefenseCenterTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingDefenseCenterTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingDefenseCenterTable) Row(i int) (row BuildingDefenseCenterRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingDefenseCenterTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingDefenseCenterRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingDefenseCenterTable) RowType() BuildingDefenseCenterRow {
    return BuildingDefenseCenterRow{}
}

func (this *BuildingDefenseCenterTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingDefenseCenterTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingDefenseCenterTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingDefenseCenterTable) createRow(records [][]string) (rows []BuildingDefenseCenterRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingDefenseCenterRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingDefenseCenterRow))
	}

    log.Trace("load table BuildingDefenseCenter len(%v)",len(rows))
	return
}

func (this *BuildingDefenseCenterTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingDefenseCenterTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingDefenseCenterTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingDefenseCenterTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingDefenseCenterTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingDefenseCenterTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingDefenseCenterTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingDefenseCenterTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingDefenseCenterTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
