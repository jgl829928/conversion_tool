...
type BuildingEmbassyRow struct {
 ...
 INT_HELP_COUNT   int32   `colname:"INT_HELP_COUNT"`
 INT_REDUCE_TIME   int32   `colname:"INT_REDUCE_TIME"`
 INT_REINFORCE_TROOPS   int32   `colname:"INT_REINFORCE_TROOPS"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingEmbassyTable struct {
	rows []BuildingEmbassyRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingEmbassy = BuildingEmbassyTable{}
)

func (this *BuildingEmbassyTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingEmbassyTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingEmbassyTable) Row(i int) (row BuildingEmbassyRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingEmbassyTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingEmbassyRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingEmbassyTable) RowType() BuildingEmbassyRow {
    return BuildingEmbassyRow{}
}

func (this *BuildingEmbassyTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingEmbassyTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingEmbassyTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingEmbassyTable) createRow(records [][]string) (rows []BuildingEmbassyRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingEmbassyRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingEmbassyRow))
	}

    log.Trace("load table BuildingEmbassy len(%v)",len(rows))
	return
}

func (this *BuildingEmbassyTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingEmbassyTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
 ...
 case "INT_HELP_COUNT" :
 return 15,true
 case "INT_REDUCE_TIME" :
 return 16,true
 case "INT_REINFORCE_TROOPS" :
 return 17,true
...
func (this *BuildingEmbassyTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingEmbassyTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_HELP_COUNT,true
 case 16 :
 return this.rows[row].INT_REDUCE_TIME,true
 case 17 :
 return this.rows[row].INT_REINFORCE_TROOPS,true
 case 18 :
...
func (this *BuildingEmbassyTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingEmbassyTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingEmbassyTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingEmbassyTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingEmbassyTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
