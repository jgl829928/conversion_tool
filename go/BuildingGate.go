...
type BuildingGateRow struct {
 ...
 INT_DEFENCE_COUNT   int32   `colname:"INT_DEFENCE_COUNT"`
 INT_DURABILITY   int32   `colname:"INT_DURABILITY"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingGateTable struct {
	rows []BuildingGateRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingGate = BuildingGateTable{}
)

func (this *BuildingGateTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingGateTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingGateTable) Row(i int) (row BuildingGateRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingGateTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingGateRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingGateTable) RowType() BuildingGateRow {
    return BuildingGateRow{}
}

func (this *BuildingGateTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingGateTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingGateTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingGateTable) createRow(records [][]string) (rows []BuildingGateRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingGateRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingGateRow))
	}

    log.Trace("load table BuildingGate len(%v)",len(rows))
	return
}

func (this *BuildingGateTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingGateTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingGateTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingGateTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_DEFENCE_COUNT,true
 case 16 :
 return this.rows[row].INT_DURABILITY,true
 case 17 :
...
func (this *BuildingGateTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingGateTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingGateTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingGateTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingGateTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
