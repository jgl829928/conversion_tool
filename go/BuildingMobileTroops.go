...
type BuildingMobileTroopsRow struct {
...
type BuildingMobileTroopsTable struct {
	rows []BuildingMobileTroopsRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingMobileTroops = BuildingMobileTroopsTable{}
)

func (this *BuildingMobileTroopsTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingMobileTroopsTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingMobileTroopsTable) Row(i int) (row BuildingMobileTroopsRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingMobileTroopsTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingMobileTroopsRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingMobileTroopsTable) RowType() BuildingMobileTroopsRow {
    return BuildingMobileTroopsRow{}
}

func (this *BuildingMobileTroopsTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingMobileTroopsTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingMobileTroopsTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingMobileTroopsTable) createRow(records [][]string) (rows []BuildingMobileTroopsRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingMobileTroopsRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingMobileTroopsRow))
	}

    log.Trace("load table BuildingMobileTroops len(%v)",len(rows))
	return
}

func (this *BuildingMobileTroopsTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingMobileTroopsTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingMobileTroopsTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingMobileTroopsTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingMobileTroopsTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingMobileTroopsTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingMobileTroopsTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingMobileTroopsTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingMobileTroopsTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
