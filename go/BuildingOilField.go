...
type BuildingOilFieldRow struct {
...
type BuildingOilFieldTable struct {
	rows []BuildingOilFieldRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingOilField = BuildingOilFieldTable{}
)

func (this *BuildingOilFieldTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingOilFieldTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingOilFieldTable) Row(i int) (row BuildingOilFieldRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingOilFieldTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingOilFieldRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingOilFieldTable) RowType() BuildingOilFieldRow {
    return BuildingOilFieldRow{}
}

func (this *BuildingOilFieldTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingOilFieldTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingOilFieldTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingOilFieldTable) createRow(records [][]string) (rows []BuildingOilFieldRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingOilFieldRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingOilFieldRow))
	}

    log.Trace("load table BuildingOilField len(%v)",len(rows))
	return
}

func (this *BuildingOilFieldTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingOilFieldTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingOilFieldTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingOilFieldTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingOilFieldTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingOilFieldTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingOilFieldTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingOilFieldTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingOilFieldTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
