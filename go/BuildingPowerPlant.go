...
type BuildingPowerPlantRow struct {
 ...
 INT_TRAIN_SPEEDUP   int32   `colname:"INT_TRAIN_SPEEDUP"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingPowerPlantTable struct {
	rows []BuildingPowerPlantRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingPowerPlant = BuildingPowerPlantTable{}
)

func (this *BuildingPowerPlantTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingPowerPlantTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingPowerPlantTable) Row(i int) (row BuildingPowerPlantRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingPowerPlantTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingPowerPlantRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingPowerPlantTable) RowType() BuildingPowerPlantRow {
    return BuildingPowerPlantRow{}
}

func (this *BuildingPowerPlantTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingPowerPlantTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingPowerPlantTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingPowerPlantTable) createRow(records [][]string) (rows []BuildingPowerPlantRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingPowerPlantRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingPowerPlantRow))
	}

    log.Trace("load table BuildingPowerPlant len(%v)",len(rows))
	return
}

func (this *BuildingPowerPlantTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingPowerPlantTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingPowerPlantTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingPowerPlantTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 16 :
 return this.rows[row].INT_TRAIN_SPEEDUP,true
 case 17 :
...
func (this *BuildingPowerPlantTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingPowerPlantTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingPowerPlantTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingPowerPlantTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingPowerPlantTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
