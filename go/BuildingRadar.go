...
type BuildingRadarRow struct {
 ...
 INT_EXTRA_SCOUT_QUEUE   int32   `colname:"INT_EXTRA_SCOUT_QUEUE"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingRadarTable struct {
	rows []BuildingRadarRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingRadar = BuildingRadarTable{}
)

func (this *BuildingRadarTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingRadarTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRadarTable) Row(i int) (row BuildingRadarRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRadarTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingRadarRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRadarTable) RowType() BuildingRadarRow {
    return BuildingRadarRow{}
}

func (this *BuildingRadarTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingRadarTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRadarTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingRadarTable) createRow(records [][]string) (rows []BuildingRadarRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingRadarRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingRadarRow))
	}

    log.Trace("load table BuildingRadar len(%v)",len(rows))
	return
}

func (this *BuildingRadarTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRadarTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingRadarTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingRadarTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 17 :
 return this.rows[row].INT_EXTRA_SCOUT_QUEUE,true
 case 18 :
...
func (this *BuildingRadarTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingRadarTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingRadarTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingRadarTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingRadarTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
