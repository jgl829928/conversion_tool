...
type BuildingRepairShopRow struct {
 ...
 INT_INJURED_CAPACITY   int32   `colname:"INT_INJURED_CAPACITY"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingRepairShopTable struct {
	rows []BuildingRepairShopRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingRepairShop = BuildingRepairShopTable{}
)

func (this *BuildingRepairShopTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingRepairShopTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRepairShopTable) Row(i int) (row BuildingRepairShopRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRepairShopTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingRepairShopRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRepairShopTable) RowType() BuildingRepairShopRow {
    return BuildingRepairShopRow{}
}

func (this *BuildingRepairShopTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingRepairShopTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRepairShopTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingRepairShopTable) createRow(records [][]string) (rows []BuildingRepairShopRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingRepairShopRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingRepairShopRow))
	}

    log.Trace("load table BuildingRepairShop len(%v)",len(rows))
	return
}

func (this *BuildingRepairShopTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRepairShopTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingRepairShopTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingRepairShopTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_INJURED_CAPACITY,true
 case 16 :
...
func (this *BuildingRepairShopTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingRepairShopTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingRepairShopTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingRepairShopTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingRepairShopTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
