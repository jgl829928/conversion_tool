...
type BuildingRubberPlantRow struct {
 ...
 INT_PRODUCTION_TYPE   int32   `colname:"INT_PRODUCTION_TYPE"`
 INT_PRODUCTION_COUNT   int32   `colname:"INT_PRODUCTION_COUNT"`
 INT_CAPACITY   int32   `colname:"INT_CAPACITY"`
 INT_INCREASE_GOLD   int32   `colname:"INT_INCREASE_GOLD"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingRubberPlantTable struct {
	rows []BuildingRubberPlantRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingRubberPlant = BuildingRubberPlantTable{}
)

func (this *BuildingRubberPlantTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingRubberPlantTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRubberPlantTable) Row(i int) (row BuildingRubberPlantRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRubberPlantTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingRubberPlantRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRubberPlantTable) RowType() BuildingRubberPlantRow {
    return BuildingRubberPlantRow{}
}

func (this *BuildingRubberPlantTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingRubberPlantTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRubberPlantTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingRubberPlantTable) createRow(records [][]string) (rows []BuildingRubberPlantRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingRubberPlantRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingRubberPlantRow))
	}

    log.Trace("load table BuildingRubberPlant len(%v)",len(rows))
	return
}

func (this *BuildingRubberPlantTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingRubberPlantTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
 ...
 case "INT_POWER" :
 return 14,true
 case "INT_PRODUCTION_TYPE" :
 return 15,true
 case "INT_PRODUCTION_COUNT" :
 return 16,true
 case "INT_CAPACITY" :
 return 17,true
 case "INT_INCREASE_GOLD" :
 return 18,true
...
func (this *BuildingRubberPlantTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingRubberPlantTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_PRODUCTION_TYPE,true
 case 16 :
 return this.rows[row].INT_PRODUCTION_COUNT,true
 case 17 :
 return this.rows[row].INT_CAPACITY,true
 case 18 :
 return this.rows[row].INT_INCREASE_GOLD,true
 case 19 :
...
func (this *BuildingRubberPlantTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingRubberPlantTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingRubberPlantTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingRubberPlantTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingRubberPlantTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
