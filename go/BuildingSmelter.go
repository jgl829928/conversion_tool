...
type BuildingSmelterRow struct {
...
type BuildingSmelterTable struct {
	rows []BuildingSmelterRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingSmelter = BuildingSmelterTable{}
)

func (this *BuildingSmelterTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingSmelterTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSmelterTable) Row(i int) (row BuildingSmelterRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSmelterTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingSmelterRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSmelterTable) RowType() BuildingSmelterRow {
    return BuildingSmelterRow{}
}

func (this *BuildingSmelterTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingSmelterTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSmelterTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingSmelterTable) createRow(records [][]string) (rows []BuildingSmelterRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingSmelterRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingSmelterRow))
	}

    log.Trace("load table BuildingSmelter len(%v)",len(rows))
	return
}

func (this *BuildingSmelterTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSmelterTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingSmelterTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingSmelterTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingSmelterTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingSmelterTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingSmelterTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingSmelterTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingSmelterTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
