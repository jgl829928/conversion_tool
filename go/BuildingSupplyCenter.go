...
type BuildingSupplyCenterRow struct {
 ...
 INT_FREE_COUNT   int32   `colname:"INT_FREE_COUNT"`
 INT_SUPPLY_STEEL   int32   `colname:"INT_SUPPLY_STEEL"`
 INT_SUPPLY_OIL   int32   `colname:"INT_SUPPLY_OIL"`
 INT_SUPPLY_RUBBER   int32   `colname:"INT_SUPPLY_RUBBER"`
 INT_SUPPLY_AMMO   int32   `colname:"INT_SUPPLY_AMMO"`
 INT_SUPPLY_CASH   int32   `colname:"INT_SUPPLY_CASH"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingSupplyCenterTable struct {
	rows []BuildingSupplyCenterRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingSupplyCenter = BuildingSupplyCenterTable{}
)

func (this *BuildingSupplyCenterTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingSupplyCenterTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSupplyCenterTable) Row(i int) (row BuildingSupplyCenterRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSupplyCenterTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingSupplyCenterRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSupplyCenterTable) RowType() BuildingSupplyCenterRow {
    return BuildingSupplyCenterRow{}
}

func (this *BuildingSupplyCenterTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingSupplyCenterTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSupplyCenterTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingSupplyCenterTable) createRow(records [][]string) (rows []BuildingSupplyCenterRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingSupplyCenterRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingSupplyCenterRow))
	}

    log.Trace("load table BuildingSupplyCenter len(%v)",len(rows))
	return
}

func (this *BuildingSupplyCenterTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingSupplyCenterTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
 ...
 case "INT_FREE_COUNT" :
 return 15,true
 case "INT_SUPPLY_STEEL" :
 return 16,true
 case "INT_SUPPLY_OIL" :
 return 17,true
 case "INT_SUPPLY_RUBBER" :
 return 18,true
 case "INT_SUPPLY_AMMO" :
 return 19,true
 case "INT_SUPPLY_CASH" :
 return 20,true
...
func (this *BuildingSupplyCenterTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingSupplyCenterTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_FREE_COUNT,true
 case 16 :
 return this.rows[row].INT_SUPPLY_STEEL,true
 case 17 :
 return this.rows[row].INT_SUPPLY_OIL,true
 case 18 :
 return this.rows[row].INT_SUPPLY_RUBBER,true
 case 19 :
 return this.rows[row].INT_SUPPLY_AMMO,true
 case 20 :
 return this.rows[row].INT_SUPPLY_CASH,true
 case 21 :
...
func (this *BuildingSupplyCenterTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingSupplyCenterTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingSupplyCenterTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingSupplyCenterTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingSupplyCenterTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
