...
type BuildingTankTroopsRow struct {
...
type BuildingTankTroopsTable struct {
	rows []BuildingTankTroopsRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingTankTroops = BuildingTankTroopsTable{}
)

func (this *BuildingTankTroopsTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingTankTroopsTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingTankTroopsTable) Row(i int) (row BuildingTankTroopsRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingTankTroopsTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingTankTroopsRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingTankTroopsTable) RowType() BuildingTankTroopsRow {
    return BuildingTankTroopsRow{}
}

func (this *BuildingTankTroopsTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingTankTroopsTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingTankTroopsTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingTankTroopsTable) createRow(records [][]string) (rows []BuildingTankTroopsRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingTankTroopsRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingTankTroopsRow))
	}

    log.Trace("load table BuildingTankTroops len(%v)",len(rows))
	return
}

func (this *BuildingTankTroopsTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingTankTroopsTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
...
func (this *BuildingTankTroopsTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingTankTroopsTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
...
func (this *BuildingTankTroopsTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingTankTroopsTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingTankTroopsTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingTankTroopsTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingTankTroopsTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
