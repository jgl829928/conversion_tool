...
type BuildingWarehouseRow struct {
 ...
 INT_PROTECT_STEEL   int32   `colname:"INT_PROTECT_STEEL"`
 INT_PROTECT_OIL   int32   `colname:"INT_PROTECT_OIL"`
 INT_PROTECT_RUBBER   int32   `colname:"INT_PROTECT_RUBBER"`
 INT_PROTECT_AMMO   int32   `colname:"INT_PROTECT_AMMO"`
 INT_REWARD_TYPE_1   int32   `colname:"INT_REWARD_TYPE_1"`
 INT_REWARD_COUNT_1   int32   `colname:"INT_REWARD_COUNT_1"`

}

type BuildingWarehouseTable struct {
	rows []BuildingWarehouseRow
    each map[int]bool
	sync.RWMutex
}

var (
    BuildingWarehouse = BuildingWarehouseTable{}
)

func (this *BuildingWarehouseTable) Reload(csvfile string) (ok bool) {
	this.Lock()
	defer this.Unlock()
...
func (this *BuildingWarehouseTable) NumRows() int {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingWarehouseTable) Row(i int) (row BuildingWarehouseRow, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingWarehouseTable) RowByINT_LEVEL(INT_LEVEL int32) (row BuildingWarehouseRow,rowIndex int, ok bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingWarehouseTable) RowType() BuildingWarehouseRow {
    return BuildingWarehouseRow{}
}

func (this *BuildingWarehouseTable) ByField(i int, field string) (row reflect.Value, ok bool) {
    this.RLock()
    defer this.RUnlock()
...
func (this *BuildingWarehouseTable) GetRowListByFieldMap(intfieldMap map[string]int32,strfieldMap map[string]string,fltfieldMap map[string]float32,count int) (rows []int) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingWarehouseTable) readfile(csvfile string) (records [][]string, ok bool) {
...
func (this *BuildingWarehouseTable) createRow(records [][]string) (rows []BuildingWarehouseRow) {
	if len(records) <= 0 {
		return
	}

    refType := reflect.TypeOf(BuildingWarehouseRow{})
	...
	for rowIndex, row := range records {
		...
		rows = append(rows, refElem.Interface().(BuildingWarehouseRow))
	}

    log.Trace("load table BuildingWarehouse len(%v)",len(rows))
	return
}

func (this *BuildingWarehouseTable) valueByField(row int,colname string) (interface{}, bool) {
	this.RLock()
	defer this.RUnlock()
...
func (this *BuildingWarehouseTable) fieldByName(colname string) (int,bool) {
    switch colname {
         case "INT_LEVEL" :
 return 0,true
 ...
 case "INT_POWER" :
 return 14,true
 case "INT_PROTECT_STEEL" :
 return 15,true
 case "INT_PROTECT_OIL" :
 return 16,true
 case "INT_PROTECT_RUBBER" :
 return 17,true
 case "INT_PROTECT_AMMO" :
 return 18,true
...
func (this *BuildingWarehouseTable) typeByName(colname string) (reflect.Kind, bool) {
	switch colname {
	 case "INT_LEVEL" :
...
func (this *BuildingWarehouseTable) intFieldValue(fieldIndex, row int) (data int32, ok bool) {
 ...
 case 15 :
 return this.rows[row].INT_PROTECT_STEEL,true
 case 16 :
 return this.rows[row].INT_PROTECT_OIL,true
 case 17 :
 return this.rows[row].INT_PROTECT_RUBBER,true
 case 18 :
 return this.rows[row].INT_PROTECT_AMMO,true
 case 19 :
...
func (this *BuildingWarehouseTable) strFieldValue(fieldIndex, row int) (data string, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingWarehouseTable) fltFieldValue(fieldIndex, row int) (data float32, ok bool) {
    if len(this.rows) <= row {
        return
    }
...
func (this *BuildingWarehouseTable) matchIntField(row int,intfieldMap map[string]int32) (match bool) {
...
func (this *BuildingWarehouseTable) matchStrField(row int,strfieldMap map[string]string) (match bool) {
...
func (this *BuildingWarehouseTable) matchFltField(row int,fltfieldMap map[string]float32) (match bool) {
